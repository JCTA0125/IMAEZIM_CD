...
public class ObjectMemo : MonoBehaviour
{
    ...
    IEnumerator LoadImage(string imageUrl)  //물건 대표 이미지
    {
        ...
        using UnityWebRequest www = UnityWebRequestTexture.GetTexture("http://34.47.85.24:8000" + imageUrl[index..]);
    ...
    {
        string url = "http://34.47.85.24:8000/object/searchObj/";
        WWWForm form = new();
    ...
    {
        string url = "http://34.47.85.24:8000/object/addText/";
        WWWForm form = new();
    ...
    {
        string url = "http://34.47.85.24:8000/object/addObj/";
        WWWForm form = new();
        for (int i = 0; i < 10; i++)
        {
